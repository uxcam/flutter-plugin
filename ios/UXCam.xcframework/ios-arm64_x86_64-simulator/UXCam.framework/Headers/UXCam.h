...
//  UXCam.h
//
//  Copyright (c) 2013-2026 UXCam Ltd. All rights reserved.
//
//  UXCam SDK VERSION: 3.8.2
//
...
/**
 *    This will opt this device out of video recordings for future settings
 *    - any current session will be stopped and restarted with the last settings passed to @c startWithKey:
 */
+ (void) optOutOfVideoRecordings;
...
/**
 *    This will opt this device into video recordings for future sessions (subject to dashboard/verify settings settings as well)
 *    - any current session will be stopped and a new session will be started with the last settings passed to @c startWithKey:
 */
+ (void) optIntoVideoRecordings;
...
/** Returns the opt-in status of this device for video recordings
 *    @returns YES if the device is opted in to video recordings, NO otherwise. The default is NO.
 *    @note Use in conjunction with optInOverallStatus to control the overall recording status for the device
 */
+ (BOOL) optInVideoRecordingStatus;
...
+ (void) optOutOfSchematicRecordings  __attribute__((deprecated("Use optOutOfVideoRecordings instead. Note: Schematic Recording is controlled from dashboard only.")));
+ (void) optIntoSchematicRecordings  __attribute__((deprecated("Use optIntoVideoRecordings instead. Note: Schematic Recording is controlled from dashboard only.")));
+ (BOOL) optInSchematicRecordingStatus  __attribute__((deprecated("Use optInVideoRecordingStatus instead. Note: Schematic Recording is controlled from dashboard only.")));
