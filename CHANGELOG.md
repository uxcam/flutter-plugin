...
Version | Changes |
-- | -- |
2.7.2           | Updated iOS SDK to 3.7.2 and Android SDK to 3.8.2 |
2.7.1           | Updated iOS SDK to 3.7.1 and Android SDK to 3.7.3 |
2.7.0           | Updated iOS SDK to 3.6.26 and Android SDK to 3.7.1 |
